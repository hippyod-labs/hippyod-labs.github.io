...
+
Images are built to contain a complete set of dependencies needed to run an application right down to its own, independent filesystem and operating system.
